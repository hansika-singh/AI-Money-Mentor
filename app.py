...
def mfa_webauthn_verify():
    ...
    try:
        data = request.json
        mfa = MFASystem(current_user)
        result = mfa.verify_webauthn(data)
